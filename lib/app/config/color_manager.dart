...
class ColorManager {
  static const Color firstDarkColor = Color(0xffE07800);
  static const Color firstColor = Color(0xffFB8500);
  static const Color firstLightColor = Color(0xffFFA947);
  static const Color middileColor = Color(0xffFFB703);
  static const Color secoundColor = Color(0xff219EBC);
  static const Color secoundDarkColor = Color(0xff023047);
  static const Color secoundLightColor = Color(0xff8ECAE6);
